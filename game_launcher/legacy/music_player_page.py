...
# W klasie MusicPlayerPage
    ...
    def _add_music_folder(self, *, import_to_internal: bool = False):
        ...
        if folder_path:
            ...
            import_target_label = 'Importowanie do "Muzyka Wewnętrzna"' if import_to_internal else 'Dodawanie do "Główna Kolejka"'
            operation_title = f"{import_target_label}: {os.path.basename(folder_path)}"
...
# W klasie MusicPlayerPage
    ...
    def _add_music_files(self, *, import_to_internal: bool = False):
        ...
        if filepaths:
            ...
            import_operation_label = 'Importowanie do "Muzyka Wewnętrzna"' if import_to_internal else 'Dodawanie do "Główna Kolejka"'
            operation_title_f = f"{import_operation_label}: {total_files_to_process_f} plików"
